...
// SniffUTP checks whether the payload is the ST_SYN packet initiating a uTP
// connection, as defined by BEP 29. Like the QUIC sniffer, it only recognizes
// a connection at its start and lets packets of established connections pass.
